...
class SwerveModuleTest {
    ...
    void testUpdateOdometryInputs() {
        ...
        // verify(swerveModule.hardwareFaultAlert).set(false); // Hardware fault alert should be false if inputs are connected
    }
    ...
    void testGetOdometryPositions() {
        ...
        SwerveModulePosition[] mockPositions = new SwerveModulePosition[] {
